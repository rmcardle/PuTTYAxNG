...
#define saves			DEFINE_AX_GET_POINTER_ARRAY( saves, struct cmdline_saved_param_set *, NPRIORITIES * sizeof( struct cmdline_saved_param_set ) )
...
#define cmdline_password				DEFINE_AX_GET_POINTER( cmdline_password, char * )

static int cmdline_get_line(const char *prompt, char *str,
                            int maxlen, int is_pw)
{
    //static int tried_once = 0;
	#define tried_once						DEFINE_AX_GET_POINTER( tried_once, int )
...
#define cmdline_tooltype				DEFINE_AX_GET_POINTER( cmdline_tooltype, int )
