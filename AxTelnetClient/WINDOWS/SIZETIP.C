...
#define tip_class			DEFINE_AX_GET_POINTER( tip_class, ATOM )

//static HFONT tip_font;
//static COLORREF tip_bg;
//static COLORREF tip_text;

#define tip_font			DEFINE_AX_GET_POINTER( tip_font, HFONT )
#define tip_bg				DEFINE_AX_GET_POINTER( tip_bg, COLORREF )
#define tip_text			DEFINE_AX_GET_POINTER( tip_text, COLORREF )
...
#define tip_wnd						DEFINE_AX_GET_POINTER( tip_wnd, HWND )
#define tip_enabled					DEFINE_AX_GET_POINTER( tip_enabled, int )
...
void UpdateSizeTip(HWND src, int cx, int cy)
{
	...
	tip_wnd =
	    CreateWindowEx(WS_EX_TOOLWINDOW | WS_EX_TOPMOST,
			   ...
			   iy, sz.cx, sz.cy, NULL, NULL, hinst_, NULL);
